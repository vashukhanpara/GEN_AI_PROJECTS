...
# LOAD MODEL + FILES
# =========================
model = tf.keras.models.load_model(os.path.join(DATA_DIR, 'model.h5'))

label_encoder_gender = pickle.load(
    open(os.path.join(DATA_DIR, 'label_encoder_gender.pkl'), 'rb')
)

onehot_encoder_geo = pickle.load(
    open(os.path.join(DATA_DIR, 'onehot_encoder_geo.pkl'), 'rb')
)

scaler = pickle.load(
    open(os.path.join(DATA_DIR, 'scaler.pkl'), 'rb')
)
